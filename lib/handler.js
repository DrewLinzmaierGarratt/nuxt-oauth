...
Handler.prototype.createAuth = function createAuth () {
  const { oauthHost, oauthClientID, oauthClientSecret, oauthScopes, authorizationUri, accessTokenUri } = Object.assign({ authorizationUri: '/oauth/authorize', accessTokenUri: '/oauth/token' }, this.opts)
